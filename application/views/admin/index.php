                                ...
                                <div class="statistic-box">
                                    <h2>
                                        <span class="count-number">
                                            <?php echo isset($total_employees) ? $total_employees : 4; ?>
                                        </span>
                                    </h2>
                                </div>
                        ...
                        <div class="panel panel-bd cardbox">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <h2>
                                        <span class="count-number">
                                        <?php echo isset($total_departments) ? $total_departments : 7; ?>
                                        </span>
                                    </h2>
                                </div>
                                <div class="items pull-left">
                        ...
                        <div class="panel panel-bd cardbox">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    ...
                                    <?php echo isset($total_hr_departments) ? $total_hr_departments : 5; ?>
