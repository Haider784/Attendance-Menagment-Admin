                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h2><?php echo isset($expense) ? 'Edit Accounts' : 'Add Accounts'; ?></h2>
                                        ...
                                        <div class="modal-body">
                                            <?php
                                            $current_date = isset($expense['date']) ? $expense['date'] : date('Y-m-d');
                                            ?>
                                            <!-- <form action="<?php echo site_url('AccountsController/insert_expense/' . (isset($expense['id']) ? $expense['id'] : '')); ?>" method="POST"> -->
                                                <form action="<?= isset($expense) ? base_url('AccountsController/update_expense/' . $expense['id']) : base_url('AccountsController/insert_expense/') ?>" method="POST">

                                                    <div class="form-group">
                                                        <label>Expense type</label>
                                                        <select class="form-control" id="department" name="expense_type">
                                                            <option disabled selected value="">Select Accounts</option>
                                                            <option value="Electricity Bill" <?php echo (isset($expense['expense_type']) && $expense['expense_type'] == 'Electricity Bill') ? 'selected' : ''; ?>>Electricity Bill</option>
                                                            <option value="Salary" <?php echo (isset($expense['expense_type']) && $expense['expense_type'] == 'Salary') ? 'selected' : ''; ?>>Salary</option>
                                                        </select>
                                                        <div class="text-danger"><?php echo form_error('expense_type'); ?></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Amount</label>
                                                        <input type="text" step="0.01" class="form-control" placeholder="Enter Amount" name="amount" value="<?php echo isset($expense['amount']) ? $expense['amount'] : ''; ?>">
                                                        <div class="text-danger"><?php echo form_error('amount'); ?></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Description</label>
                                                        <textarea class="form-control" rows="3" placeholder="Enter Description" name="description"><?php echo isset($expense['description']) ? $expense['description'] : ''; ?></textarea>
                                                        <div class="text-danger"><?php echo form_error('description'); ?></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Expense Date</label>
                                                        <input type="date" class="form-control" id="date" placeholder="Enter Expense Date" name="date" value="<?php set_value('date', $current_date) ?>">
                                            ...
                                            <?php if (!empty($expenses)) {
                                                ...
                                                <?php foreach ($expenses as $expense) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo substr ($expense['description'], 0,10) .'...'; ?></td>
                                                        <td><?php echo $expense['date']; ?></td>
                                                        <td class="no-print">
                                                            <a href="<?php echo site_url('AccountsController/edit_expense/' . $expense['id']); ?>"><i class="fa fa-pencil" aria-hidden="true" style="color: #007BFF;"></i></a> |
                                                            <a href="<?php echo site_url('AccountsController/delete_expense/' . $expense['id']); ?>"
