        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="header-title">
                    ...
                    <h1>Expnses</h1>
                    <small>Expnses table</small>
                    <ol class="breadcrumb hidden-xs">
                        <li><a href="index-2.html"><i class="pe-7s-home"></i> Home</a></li>
                        <li class="active">expnses_list</li>
                    </ol>
                </div>
            </section>
            <!-- Main content -->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-bd lobidrag">
                            ...
                            <div class="btn-group">
                                    <a class="btn btn-primary" href="<?=base_url('add_expenses')?>"> <i class="fa fa-wpforms" aria-hidden="true"></i>
                                        Expenses form </a>
                                </div>
                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php foreach ($employees as $employee) : ?>
                                                                ...
                                                                <?php if ($expense['employee_id']  == $employee->emp_id) : ?>
                                                                    <?= $employee->emp_name ?>
                                                                <?php endif; ?>
                                                            <?php endforeach; ?>
                                                        </td>
                                                        ...
                                                        <td><?= substr($expense['description'],0,10). '...'; ?></td>
                                                        <td><?= $expense['invoice_number'] ?></td>
                                                        <td class="no-print">
                                                            <a href="<?= site_url('ExpenseController/edit/' . $expense['id']) ?>"><i class="fa fa-pencil" aria-hidden="true" style="color: #007BFF;"></i></a> |
                                                            <a href="<?= site_url('ExpenseController/delete/' . $expense['id']) ?>"
