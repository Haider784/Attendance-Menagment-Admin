                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-bd lobidrag">
                            <div class="panel-heading">
                                ...
                                <div class="btn-group">
                                    <a class="btn btn-primary" href="<?= base_url('add_department') ?>"> <i class="fa fa-wpforms" aria-hidden="true"></i>
                                        Departments form</a>
                                </div>
                            ...
                            <div class="panel-body">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="dataTables_length" id="example_length">
                                                <div class="input-group custom-search-form">
                                                    ...
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-primary" type="button" onclick="changePage(1)">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="printTable">
                                        ...
                                        <tbody id="tableBody">
                                            <?php if (!empty($departments)) : $i = 0; ?>
                                                <?php foreach ($departments as $department) : ?>
                                                    <tr>
                                                        <td><?= ++$i ?></td>
                                                        <td><?php echo $department['name']; ?></td>
                                                        <td><?php echo $department['hr']; ?></td>
                                                        <td class="no-print">
                                                            <a href="<?php echo site_url('DepartmentController/update/' . $department['id']); ?>"><i class="fa fa-pencil" aria-hidden="true" style="color: #007BFF;"></i></a> |
                                                            <a href="<?php echo site_url('DepartmentController/delete/' . $department['id']); ?>"
                                                                onclick="return confirm('Are you sure you want to delete this data?');">
                                                                <i class="fa fa-trash-o" aria-hidden="true" style="color: red;"></i>
                                                            </a>

                                                            <!-- <a href="<?php echo site_url('DepartmentController/delete/' . $department['id']); ?>"><i class="fa fa-trash-o" aria-hidden="true" style="color: red;"></i></a> -->
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php else : ?>
