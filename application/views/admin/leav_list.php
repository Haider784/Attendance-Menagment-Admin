 <!DOCTYPE html>
 <html lang="en">
 <!-- Mirrored from thememinister.com/health/sch-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jul 2024 05:55:49 GMT -->
                     ...
                     <div class="col-sm-12">
                         <div class="panel panel-bd lobidrag">
                             <div class="panel-heading">
                                 <div class="btn-group">
                                     <a class="btn btn-primary" href="<?= base_url('add_leave') ?>"> <i class="fa fa-wpforms" aria-hidden="true"></i>
                                         Leave form</a>
                                 </div>
                             </div>
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td>
                                                             <?php foreach ($employees as $employee): ?>
                                                                 <?php if ($leave['employee_id'] ==  $employee->emp_id) : ?>
                                                                     <?= $employee->emp_name  ?>
                                                                 <?php endif; ?>
                                                             <?php endforeach; ?>
                                                         </td>
                                                         ...
                                                         <td><?= $leave['status'] ?></td>
                                                         <td class="no-print">
                                                             <a href="<?= site_url('LeaveController/edit/' . $leave['id']) ?>"><i class="fa fa-pencil"
                                                                     aria-hidden="true" style="color: #007BFF;"></i></a> |
                                                             <a href="<?= site_url('LeaveController/delete/' . $leave['id']) ?>"
                                                                 onclick="return confirm('Are you sure you want to delete this data?');"><i class="fa fa-trash-o"
