        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="header-title">
                    ...
                    <h1>Pay_slip</h1>
                    <small>Pay_slip table</small>
                    <ol class="breadcrumb hidden-xs">
                        <li><a href="index-2.html"><i class="pe-7s-home"></i> Home</a></li>
                        <li class="active">Pay_slip</li>
                    </ol>
                </div>
            </section>
            <!-- Main content -->
                        ...
                        <div class="panel panel-bd lobidrag">
                            <div class="panel-heading">
                                ...
                                <div class="btn-group">
                                    ...
                                    <a class="btn btn-primary"> <i class="fa fa-wpforms" aria-hidden="true"></i>
                                        Wages form </a>
                                </div>
                                <?php if (isset($is_update) && $is_update) : ?>
                                    <div class="btn-group">
                                        <a class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                                            <i class="fa fa-wpforms" aria-hidden="true"></i> Wages Form
                                        </a>
                                    </div>
                                <?php endif; ?>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h3 class="modal-title" id="exampleModalLabel">Salary form</h3>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <!-- <form action="<?php echo base_url('SalaryController/update'); ?>" method="post">
                                                <input type="hidden" name="id" value="<?php echo $salary->id; ?>">
                                                <div class="form-group">
                                                    <label for="salary_paid">Salary Paid</label>
                                                    <select name="salary_paid" class="form-control" id="salary_paid">
                                                        <option value="yes" <?php echo $salary->salary_paid ? 'selected' : ''; ?>>Yes</option>
                                                        <option value="no" <?php echo !$salary->salary_paid ? 'selected' : ''; ?>>No</option>
                                                    </select>
                                                </div>
                                            ...
                                            <form action="<?php echo base_url('SalaryController/update'); ?>" method="post">
                                                <input type="hidden" name="id" value="<?php echo isset($salary->id) ? $salary->id : ''; ?>">
                                                <div class="form-group">
                                                    <label for="salary_paid">Salary Paid</label>
                                                    <select name="salary_paid" class="form-control" id="salary_paid">
                                                        <option disabled selected>Select status </option>
                                                        <option value="yes" <?php echo isset($salary->salary_paid) && $salary->salary_paid ? 'selected' : ''; ?>>Yes</option>
                                                        <option value="no" <?php echo isset($salary->salary_paid) && !$salary->salary_paid ? 'selected' : ''; ?>>No</option>
                                                    </select>
                                                </div>
                                                <div class="form-group text-center" style="padding-top: 15px;">
                                                    <button type="button" class="btn btn-warning" data-dismiss="modal">Close</button>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table id="printTable" class="table table-bordered table-hover mt-3">
                                        ...
                                        <tbody id="tableBody">
                                            <?php if (!empty($calculated_salaries)) : ?>
                                                <?php foreach ($calculated_salaries as $index => $salary) : ?>
                                                    <tr>
                                                        <td><?php echo $index + 1; ?></td>
                                                        <td><?php foreach ($employees as $employee) : ?>
                                                                <?php if ($salary->employee_id   == $employee->emp_id) :  ?>
                                                        ...
                                                        <td>
                                                            <?php foreach ($wages as $wage) : ?>
                                                                <?php if ($salary->employee_id == $wage['emp_id']) : ?>
                                                                    <?php echo $wage['loan_type']; ?>
                                                                <?php endif; ?>
                                                            <?php endforeach; ?>
                                                        </td>

                                                        <td><?php echo $salary->calculation_date; ?></td>
                                                        <td><?php echo $salary->salary_paid ? 'Yes' : 'No'; ?></td>
                                                        <td class="no-print">
                                                            <a href="<?php echo base_url('SalaryController/edit/' . $salary->id); ?>"><i class="fa fa-pencil" aria-hidden="true" style="color: green;"></i></a> |
                                                            <a href="<?php echo base_url('SalaryController/view/' . $salary->employee_id); ?>"><i class="fa fa-eye" aria-hidden="true" style="color: green;"></i>
                                ...
                                <div class="page-nation text-right">
                                    <ul class="pagination pagination-large" id="pagination">
