                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-bd lobidrag">
                            <div class="panel-heading">
                                ...
                                <div class="btn-group">
                                    <a class="btn btn-primary" href="<?= base_url('Attendance')?>"> <i class="fa fa-list"></i> Attendance form</a>
                                </div>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table id="printTable" class="table table-bordered table-hover">
                                        ...
                                        <tbody id="tableBody">
                                            <?php if (!empty($attendance)) : $i = 1; ?>
                                                <?php foreach ($attendance as $attendance_item) : ?>
                                                    <tr>
                                                        <td><?php echo $i++ ?></td>
                                                        <td>
                                                            <?php foreach ($employees as $employee) : ?>
                                                                <?php if ($attendance_item['employee_id'] == $employee->emp_id) : ?>
                                                                    <?= $employee->emp_name; ?>
                                                                <?php endif; ?>
                                                            <?php endforeach; ?>
                                                        </td>
                                                        <td><?php echo $attendance_item['date']; ?></td>
                                                        <td><?php echo date('g:i A', strtotime($attendance_item['check_in_time'])); ?></td>
                                                        <td><?php echo date('g:i A', strtotime($attendance_item['check_out_time'])); ?></td>
                                                        <td><?php echo $attendance_item['work_holiday']; ?></td>
                                                        <td>
                                                            <?php if ($attendance_item['status'] == 1) : ?>
                                                        ...
                                                        <td class="no-print">
                                                            <a href="<?php echo site_url('AttendanceController/update/' . $attendance_item['id']); ?>"><i class="fa fa-pencil" aria-hidden="true" style="color: #007BFF;"></i></a> |
                                                            <a href="<?php echo site_url('AttendanceController/delete_attendance/' . $attendance_item['id']); ?>"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel panel-bd lobidrag">
                            <div class="panel-heading">
                                <div class="btn-group">
                                    <a class="btn btn-primary" href="table.html">
                                        <i class="fa fa-list"></i> Doctor List
                                    </a>
                                </div>
                            </div>
                            <div class="panel-body">
                                <!-- Form content can be placed here -->
                            </div>
                        </div>
                    </div>
